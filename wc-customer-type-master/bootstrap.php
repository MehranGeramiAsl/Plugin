...
class WC_Customer_Type
{
     ...
     * @var string
     */
    public static $plugin_slug = 'wc-customer-type';
    ...
    public function define_constants()
    {
        ...
        self::$plugin_main_file = self::$plugin_path . 'wc-customer-type.php';
    ...
    public function includes()
    {
        ...
        */
         ...
         */
        do_action('wc_customer_type_loaded');
    }
    ...
    public function init_hooks()
    {
        ...
        if (self::$use_i18n === true) {
            load_plugin_textdomain('wc-customer-type', false, wp_normalize_path(self::$plugin_path . '/languages'));
        }
    }
    ...
    public function php_version_notice()
    {
        ...
        $error = __('Your installed PHP Version is: ', 'wc-customer-type') . PHP_VERSION . '. ';
        $error .= __('The <strong>WP Customer Type</strong> plugin requires PHP version <strong>', 'wc-customer-type') . $this->min_php . __('</strong> or greater.', 'wc-customer-type');
        ?>
        <div class="error">
 ...
 * @since  1.1.0
 */
function wc_customer_type_api()
{
    return WC_Customer_Type::instance();
}

// Global for backwards compatibility.
$GLOBALS['wc-customer-type'] = wc_customer_type_api();
