...
class WC_Customer_Address
{
     ...
     * @var string
     */
    public static $plugin_slug = 'wc-customer-address';
    ...
    public function define_constants()
    {
        ...
        self::$plugin_main_file = self::$plugin_path . 'wc-customer-address.php';
    ...
    public function includes()
    {
        ...
        require_once dirname(__FILE__) . '/inc/post-type/WC_Address.php';
        require_once dirname(__FILE__) . '/inc/City.php';
        ...
        */
         ...
         */
        do_action('wc_customer_address_loaded');
    }
    ...
    public function init_hooks()
    {
        ...
        if (self::$use_i18n === true) {
            load_plugin_textdomain('wc-customer-address', false, wp_normalize_path(self::$plugin_path . '/languages'));
        }
    }
    ...
    public function php_version_notice()
    {
        ...
        $error = __('Your installed PHP Version is: ', 'wc-customer-address') . PHP_VERSION . '. ';
        $error .= __('The <strong>WP Customer Address</strong> plugin requires PHP version <strong>', 'wc-customer-address') . $this->min_php . __('</strong> or greater.', 'wc-customer-address');
        ?>
        <div class="error">
 ...
 * @since  1.1.0
 */
function wc_customer_address_api()
{
    return WC_Customer_Address::instance();
}

// Global for backwards compatibility.
$GLOBALS['wc-customer-address'] = wc_customer_address_api();
